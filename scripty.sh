...
case "$1" in
    1) LAN_SEGMENT="172.16.0.0/16";;
    2) LAN_SEGMENT="172.18.0.0/16";;
    3) LAN_SEGMENT="172.19.0.0/16";;
    4) LAN_SEGMENT="172.20.0.0/16";;
    5) LAN_SEGMENT="172.21.0.0/16";;
    6) LAN_SEGMENT="172.22.0.0/16";;
    7) LAN_SEGMENT="172.23.0.0/16";;
    8) LAN_SEGMENT="172.24.0.0/16";;
    *) echo "Usage: $0 [1-8]" >&2
       exit 1;;
esac
